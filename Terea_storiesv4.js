...
if (reversed == null) { reversed = false; }
	...
	// Layer_7
	this.instance_7 = new lib.bm_bungkus();
	this.instance_7.setTransform(-121.5,35.25,0.7628,0.7628);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.pr_pack();
	this.instance_8.setTransform(-140.1,36.8,0.5011,0.5011,0,0,0,-0.1,0);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(15).to({_off:false},0).to({regX:-0.2,scaleX:0.7403,scaleY:0.7403,x:-62.1,y:4.4,alpha:1},9).to({_off:true},11).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(50).to({_off:false},0).to({regX:-0.3,regY:0.1,scaleX:0.4899,scaleY:0.4898,x:-54.35,y:2.4,alpha:1},9).wait(11));

	// Layer_8
	this.instance_9 = new lib.bm_pearl();
	this.instance_9.setTransform(5.4,-67.6,0.6916,0.6916,32.7146,0,0,0.1,-0.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.instance_10 = new lib.pr_pearl();
	this.instance_10.setTransform(-2.7,-62.8,0.4078,0.4078,32.7132,0,0,-0.1,-0.2);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(6).to({_off:false},0).to({regX:0,regY:0,scaleX:0.8846,scaleY:0.8846,rotation:0,x:85.15,y:-120.2,alpha:1},13).to({_off:true},16).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(41).to({_off:false},0).to({regX:0.3,regY:-0.3,scaleX:0.5408,scaleY:0.5408,rotation:0,x:94.55,y:-116.7,alpha:1},13).wait(16));

	// Layer_6
	this.instance_11 = new lib.bm_splash3();
	this.instance_11.setTransform(-3.25,-57.05,0.6352,0.6352,-90,0,0,0,-0.1);
	this.instance_11._off = true;

	this.instance_12 = new lib.pr_splash3();
	this.instance_12.setTransform(-3.25,-57.05,0.4132,0.4132,-90,0,0,0,-0.1);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(4).to({_off:false},0).to({regY:0,scaleX:0.8846,scaleY:0.8846,rotation:0,x:0.05,y:-64.25},10).to({_off:true},21).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(39).to({_off:false},0).to({regX:0.1,scaleX:0.614,scaleY:0.614,rotation:0,x:1.65,y:-65.7,alpha:1},10).wait(21));

	// Layer_3
	this.instance_13 = new lib.bm_splash2();
	this.instance_13.setTransform(0,-65,0.3691,0.3691);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.instance_14 = new lib.pr_splash2();
	this.instance_14.setTransform(0,-65,0.3691,0.3691);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(2).to({_off:false},0).to({scaleX:0.8846,scaleY:0.8846,x:0.05,y:-64.25,alpha:1},12).to({_off:true},21).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(37).to({_off:false},0).to({regX:0.1,regY:-0.1,scaleX:0.614,scaleY:0.614,x:1.65,y:-65.7,alpha:1},12).wait(21));

	// Layer_9
	this.instance_15 = new lib.bm_splash1();
	this.instance_15.setTransform(0,-65,0.2609,0.2609);
	this.instance_15.alpha = 0;

	this.instance_16 = new lib.pr_splash1();
	this.instance_16.setTransform(0,-65,0.1636,0.1636);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({scaleX:0.8846,scaleY:0.8846,x:0.05,y:-64.25,alpha:1},6).to({_off:true},29).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(35).to({_off:false},0).to({regX:0.1,regY:-0.1,scaleX:0.614,scaleY:0.614,x:1.65,y:-65.7,alpha:1},6).wait(29));

	// Layer_2
	this.instance_17 = new lib.bbg();
	this.instance_17.setTransform(-4.75,-59.9,0.8803,0.8803);
	this.instance_17.alpha = 0;

	this.instance_18 = new lib.pr_bg();
	this.instance_18.setTransform(0,-60,0.7817,0.7817,0,0,0,0,-0.1);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({regX:0.1,regY:-0.1,scaleX:0.8846,scaleY:0.8846,x:0.15,y:-57.65,alpha:1},4).to({_off:true},31).wait(35));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(35).to({_off:false},0).to({regX:0.1,scaleX:1.1509,scaleY:1.1509,x:0.15,y:-57.65,alpha:1},4).wait(31));
