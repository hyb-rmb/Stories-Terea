...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-157.05,-277.75,1.5136,1,0,0,0,-52,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_4,p:{x:-157.05}}]}).to({state:[{t:this.shape_1},{t:this.instance_4,p:{x:-0.35}}]},20).wait(20));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-311.2,-281.2,471.29999999999995,473.2);
...
p.nominalBounds = new cjs.Rectangle(8.8,217.9,327.5,287.5);
// library properties:
lib.properties = {
